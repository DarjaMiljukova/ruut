...
var1=StringVar()
var2=StringVar()
c1=Checkbutton(f,text='Esimene',font="Algerian 20",variable=var1,onvalue='Esimene pn valitud',offvalue='Esimene on peidetud')
c2=Checkbutton(f,text='Esimene',font="Algerian 20",variable=var2,onvalue='Teine pn valitud',offvalue='Teine on peidetud')
